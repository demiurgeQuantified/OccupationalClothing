    ...
    professionTable['fireofficer'] = {
        {
            ...
            ['Shirt'] = 'STFR.Shirt_Fire_Tikitown',
            ['Tshirt'] = {'STFR.TShirt_Profession_Fireman_Blue_Tikitown', 'STFR.TShirt_Profession_Fireman_Red_Tikitown', 'STFR.TShirt_Profession_Fireman_Red_Tikitown02', 'STFR.TShirt_Profession_Fireman_White_Tikitown',},
