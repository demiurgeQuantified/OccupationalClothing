    ...
    professionTable['fireofficer'] = {
        {
            ...
            ['Shirt'] = 'STFR.Shirt_Fire_Tandil',
            ['Tshirt'] = {'STFR.TShirt_Profession_Fireman_Blue_Tandil', 'STFR.TShirt_Profession_Fireman_Red_Tandil', 'STFR.TShirt_Profession_Fireman_Red_Tandil02', 'STFR.TShirt_Profession_Fireman_White_Tandil',},
